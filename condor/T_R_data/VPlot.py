...
# 所读文件名称
infile = ROOT.TFile.Open("conversion_results.root","READ")
histos = []
legendLines = []
...
goodColours = [ROOT.kPink,ROOT.kGreen,ROOT.kCyan,ROOT.kOrange,ROOT.kBlack,ROOT.kViolet,ROOT.kAzure,ROOT.kBlue,ROOT.kMagenta,ROOT.kRed,ROOT.kYellow,ROOT.kGreen]

# Make a legend.
# These are the locations of the left side, bottom side, right
# side, and top, as fractions of the canvas.
legend = ROOT.TLegend(0.4,0.72,0.72,0.92)
