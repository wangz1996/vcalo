...
# 所读文件名称
infile = ROOT.TFile.Open("Tnew.root","READ")
histos = []
legendLines = []
...
goodColours = [ROOT.kPink,ROOT.kGreen,ROOT.kCyan,ROOT.kOrange,ROOT.kBlack,ROOT.kViolet,ROOT.kAzure+3,ROOT.kBlue,ROOT.kMagenta,ROOT.kRed,ROOT.kYellow,ROOT.kGreen]
