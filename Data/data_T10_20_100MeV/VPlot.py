...
# 所读文件名称
infile = ROOT.TFile.Open("energy_vs_thickness.root","READ")
histos = []
legendLines = []
...
for histo, line in zip(histos,legendLines) :
  ...
  histo.GetYaxis().SetTitle("conve_peak")
