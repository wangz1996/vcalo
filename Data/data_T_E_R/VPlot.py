...
# 所读文件名称
infile = ROOT.TFile.Open("conversion_ratio_T_E.root","READ")
histos = []
legendLines = []
...
goodColours = [ROOT.kPink,ROOT.kGreen,ROOT.kCyan,ROOT.kOrange,ROOT.kBlack,ROOT.kViolet,ROOT.kBlue,ROOT.kMagenta,ROOT.kRed,ROOT.kYellow,ROOT.kSpring,ROOT.kAzure]
...
for histo, line in zip(histos,legendLines) :
  ...
  histo.GetXaxis().SetTitle("thickness")
  histo.GetYaxis().SetTitle("conversion ratio")
  # Move the label around if you want
  histo.GetYaxis().SetTitleOffset(1.5)
  histo.GetYaxis().SetRangeUser(0.14, 0.58)
  ...
  if index==0 :
    ...
    histo.Draw("PL SAME") # SAME means don't get rid of the previous stuff on the canvas
