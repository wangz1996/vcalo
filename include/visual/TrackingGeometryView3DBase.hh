...
#include "CylindricalTrackingGeometry.hh"
...
static inline std::string run(const TrackingVolume& tv,IVisualization3D& helper, bool triangulate,
  ...
  const Acts::TrackingVolume& tgVolume = tv;
